...
!function (t, e) {
  ...
  function h(t, e, i, n, r) {
    ...
    var p = t.element;
    t.reach[h] = null,
    p[s] < 1 && (t.reach[h] = 'start'),
    p[s] > t[l] - t[o] - 1 && (t.reach[h] = 'end'),
    e && (p.dispatchEvent(c('ps-scroll-' + h)), e < 0 ? p.dispatchEvent(c('ps-scroll-' + u))  : e > 0 && p.dispatchEvent(c('ps-scroll-' + d)), n && a(t, h)),
  ...
  W.prototype.eventElement = function (t) {
    ...
    return e || (e = new Y(t), this.eventElements.push(e)),
    e
  },
  ...
  R = function (t) {
    ...
    !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = f(t, u(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = u((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth)))  : t.scrollbarXActive = !1,
    ...
    wheel: function (e) {
      ...
      function r(e, i, n) {
        ...
        for (var r = e; r && r !== o; ) {
          ...
          if ([l.overflow,
          l.overflowX,
          l.overflowY].join('').match(/(scroll|auto)/)) {
    ...
    touch: function (t) {
      ...
      function c() {
        !b && g && (g = !1, t.settings.swipeEasing && (clearInterval(f), f = setInterval(function () {
          t.isInitialized ? clearInterval(f)  : p.x || p.y ? Math.abs(p.x) < 0.01 && Math.abs(p.y) < 0.01 ? clearInterval(f)  : (i(30 * p.x, 30 * p.y), p.x *= 0.8, p.y *= 0.8)  : clearInterval(f)
        }, 10)))
      }
  ...
  H = function (n, r) {
    var l = this;
    if (void 0 === r && (r = {
    }), 'string' == typeof n && (n = document.querySelector(n)), !n || !n.nodeName) throw new Error('no element is specified to initialize PerfectScrollbar');
    this.element = n,
    ...
    isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !0, this.scrollbarYLeft = u(h.left))  : this.isScrollbarYUsingRight = !0,
