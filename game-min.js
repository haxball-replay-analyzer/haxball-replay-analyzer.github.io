(function (qc) {
  ...
  sortTable = function(par) {
	...
	if (im.scrollTopMax>50 && window.innerHeight>950) document.getElementsByClassName("dialog kick-player-view")[0].style="overflow-y: scroll; position:fixed; top:10px; height: 900px";
