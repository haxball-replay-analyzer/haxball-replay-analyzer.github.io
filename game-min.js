...
kb.N = '<div class=\'choose-nickname-view\'><img src="images/falafcio.png" /><div class=\'dialog\'><h1>FalaHax</h1><div style=\'display: none\' class=\'label-input\'><label>Nick:</label><input data-hook=\'input\' type=\'text\' /></div><button id=\'button_ok\' data-hook=\'ok\'>Start</button></div></div>';
