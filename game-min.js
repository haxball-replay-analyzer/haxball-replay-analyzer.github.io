  ...
  function ja(a) {
	...
	a.get('staty').onclick = function () {
	  ...
	  setTimeout(function() {
		  ...
		  else document.getElementById("tytul").innerHTML = "Match stats:";
