  ...
  sortTable = function(par) {
	  ...
	  if (par>0) {
		  for (var i=0; i<tab.length; i++) {
			  ...
			  newCell_1.setAttribute('onmouseover', 'this.style.cursor= "pointer"; heatMap(this.innerHTML.substring(33))')
			  /*
			  newCell_1 = newRow.insertCell();
