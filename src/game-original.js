import './scripts/LZWEncoder'
import './scripts/modernizr-custom'
import './scripts/GIFEncoder'
import './scripts/NeuQuant'
import './vendor/pako-jszip.min.js'
import './vendor/json5.min.js'
import './vendor/perfect-scrollbar.min.js'
import $ from 'jquery'
...
newCell.appendChild(newText);*/
  ...
  function za(a) {
    ...
    this.g.ondrop = function (c) {
      ...
      if (null != c) {
        c = K.parseInt(c); null != c && ia.i(b.mg, c, a)
      }
    };
        ...
        c.onload = function () {
          try {
            ...
            if (b = k instanceof q) {
              ...
              if (k instanceof SyntaxError || b instanceof SyntaxError) {
                y.i(a.fi, 'SyntaxError in line: ' + K.ye(b.lineNumber))
              } else {
                b instanceof Bb ? y.i(a.fi, b.xp) : y.i(a.fi, 'Error loading stadium file.')
              }
            }
          }
        };
  ...
  function Va(a, b, c) {
    ...
    this.Ra.onicecandidate = function (a) {
      if (null == a.candidate) {
        ...
        a = a.candidate;
        if (null != a.candidate && '' != a.candidate) {
          null != d.jg && d.jg(a);
          d.Uf.push(a)
        }
      }
  ...
  Sa.prototype = {
    ...
    Fi: function (a) {
      ...
      if (null != this.Mc || null != a) {
        ...
        this.Mc = a.slice(0);
        this.Ag = !0;
        if (null != this.X && 1 == this.X.readyState && null == this.ke) {
          this.Ai();
  ...
  Mb.prototype = {
    ...
    $g: function (a) {
      ...
      a *= this.Qd;
      for (var b = this.$a[0].weight, c = 0; c < this.$a.length - 1 && !(b >= a);) {
        ++c;
        b += this.$a[c].weight;
      }
