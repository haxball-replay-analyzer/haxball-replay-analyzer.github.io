...
self.onmessage = function (event) {
  ...
  if (data?.do === 'newReplay') {
    newReplay();
  } else if (data?.do === 'parseReplay') {
    y.i(parseReplay, data.rec)
  }
}
  ...
  C: function (a) {
    if (0 < this.Oa) 120 > this.Oa && this.Oa--;
      ...
      if (0 == this.Bb) {
        ...
        if (!match[match.length - 1].stadium) {
